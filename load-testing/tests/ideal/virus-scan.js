...
/*
	...
	Sample command (execute from this folder):
		...
		-e VIRUS_SCAN_IDEAL_TARGET=5000 -e VIRUS_SCAN_IDEAL_VUS=100 -e VIRUS_SCAN_IDEAL_MAX_DURATION='60' -e VIRUS_SCAN_SLEEP=0.5 
...
export function handleSummary(data) {
    const summaryPath = `../../results/summary/${__ENV.dt}/virus-scan-ideal.html`;
    return {
