...
export class Create1690919775722 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
		...
		*/
        ...
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "active_pin" (
		...
		*/
        ...
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "pin_audit_log" (
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.dropTable('active_pin', true);
        await queryRunner.dropTable('permission', true);
        await queryRunner.dropTable('pin_audit_log', true);
        await queryRunner.query(`DROP TYPE IF EXISTS ${schemaName}.role_type`);
        await queryRunner.query(
            `DROP TYPE IF EXISTS ${schemaName}.parcel_status_type`,
        );
